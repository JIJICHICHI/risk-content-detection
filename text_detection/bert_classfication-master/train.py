...
def set_args():
    ...
    parser.add_argument('--model', default='bert_wwm', type=str, required=False, help='使用什么模型')
    ...
    #                     help='单标签分类还是多标签分类 multi_label_classification, single_label_classification')
    parser.add_argument('--epochs', default=20, type=int, required=False, help='训练多少代')
    parser.add_argument('--dir_name', default='fraud_text', type=str, required=False, help='训练集存放目录,里面包含train.csv test.csv dev.csv')
